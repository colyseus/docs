...
<Cards>
    <Cards.Card title="Schema Type" href="#schema-type" arrow />
    <Cards.Card title="Primitive Types" href="#primitive-types" arrow />
    <Cards.Card title="ArraySchema" href="#arrayschema" arrow />
    <Cards.Card title="MapSchema" href="#mapschema" arrow />
    <Cards.Card title="SetSchema" href="#setschema" arrow />
    <Cards.Card title="CollectionSchema" href="#collectionschema" arrow />
</Cards>

...
- ~database~ ([paused until 2025](https://github.com/colyseus/colyseus/issues/594#issuecomment-1881050527)) + ~user auth system~ (introduced in [0.15.15](https://github.com/colyseus/colyseus/releases/tag/0.15.15), [see docs](https://docs.colyseus.io/auth/module/)).

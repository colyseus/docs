...
description: "Colyseus Cloud is managed infrastructure for Colyseus applications by the framework's own team. Deploy, scale, and monitor without managing servers."
---
...
Colyseus Cloud is the easiest way to deploy your Colyseus servers. Your server can be up and ready for production in less than 15 minutes.
...
The first deployment generates a `.colyseus-cloud.json` file at the root of your project with credentials capable of deploying your application in the future. Keep this file safe!

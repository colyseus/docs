---
title: "Colyseus SDK for WeChat"
description: "Integrate Colyseus with WeChat mini-games for real-time multiplayer. Set up the JavaScript SDK in the WeChat development environment."
---
...
<Callout type="info">
  The [JavaScript / TypeScript SDK](/getting-started/typescript) is compatible with WeChat after applying the necessary polyfills and monkey-patches.
</Callout>
...
Users have reported that the WeChat JavaScript runtime does not support sending `Uint8Array` or `Array` data types directly through WebSocket. To work around this, you can monkey-patch the `WebSocket.send` method to convert these data types to a format that WeChat can handle.
...
- [JavaScript / TypeScript SDK](/getting-started/typescript) - Full SDK setup guide

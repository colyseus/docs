...
The [Colyseus Native SDK](https://github.com/colyseus/native-sdk) provides a pure C API for integrating Colyseus into any engine or framework. It is the shared foundation behind the Godot, GameMaker, Defold, and [Flutter](/getting-started/flutter) SDKs, and can be used directly for custom engines or platforms such as Raylib, SDL, or embedded systems.

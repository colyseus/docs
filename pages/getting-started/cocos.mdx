---
title: "Colyseus SDK for Cocos Creator"
description: "Set up Colyseus multiplayer in Cocos Creator 3. Install the SDK extension, import it in TypeScript components, and connect to Colyseus rooms."
---
...
The Colyseus SDK for Cocos Creator works in the same way as the [JavaScript / TypeScript SDK](/getting-started/typescript). The major difference is how to [import it from a TypeScript Component](#importing-from-the-extension) asset from Cocos Creator.
...
- [Download the latest `colyseus-sdk.zip` release from GitHub](https://github.com/colyseus/colyseus/releases?q=%22%40colyseus%2Fsdk%22&expanded=true).

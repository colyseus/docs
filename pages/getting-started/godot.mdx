...
<Callout type="warning">
    The GDExtension is in **beta**, and may not be stable. Please [report any issues you find](https://github.com/colyseus/native-sdk/issues/8).
</Callout>
...
The State Schema Codegen is optional but recommended: it gives you type safety and autocomplete in your IDE.

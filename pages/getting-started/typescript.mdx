...
description: "Install and set up the Colyseus TypeScript SDK for building real-time multiplayer games. Includes type-safe client, room connections, and state synchronization."
---

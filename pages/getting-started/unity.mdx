...
The example project [included in the SDK package](https://github.com/colyseus/colyseus-unity-sdk/tree/master/Assets/RawExample) does not contain any visual components or UI. It contain the majority of important method calls you would be using in a real-world application.

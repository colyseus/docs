---
title: "Colyseus SDK for Discord Activities"
description: "Build multiplayer Discord Activities with Colyseus. Use the project template to create real-time HTML5 multiplayer experiences embedded in Discord."
---
...
[This Project Template](https://github.com/colyseus/discord-activity) is a starting point for crafting HTML5 multiplayer Discord Activities.

![Video](/tutorial/discord/video.gif)

<Callout type="info">
    Check out the [Discord Activity Examples](/learn/examples/discord) to see how to use the Discord Activity SDK with Colyseus.
</Callout>

## Project Structure

The frontend and backend are separated into two different modules.
...
![cloudflared-screenshot](/tutorial/discord/cloudflared-screenshot.png)
...
<div float="left">
  <img src="/tutorial/discord/settings-oauth.png" width="49%" />
  <img src="/tutorial/discord/settings-url-mappings.png" width="49%" />
</div>
...
![Production URL Mappings](/tutorial/discord/production-url-mappings.png)
...
<Callout type="info">
  You can use services like Vercel, Netlify, or Heroku to deploy your client project. For the server project, use [Colyseus Cloud](https://colyseus.io/cloud-managed-hosting/), [Vultr](https://www.vultr.com/marketplace/apps/colyseus/?ref=8013231), AWS, or DigitalOcean.
</Callout>

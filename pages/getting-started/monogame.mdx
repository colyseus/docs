...
If you set a breakpoint in your application while the WebSocket connection is open, it closes after 3 seconds of inactivity. To prevent the WebSocket connection from dropping, use `pingInterval: 0` during development:

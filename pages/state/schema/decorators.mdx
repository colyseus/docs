...
This page documents the decorator equivalents of the [main schema reference](/state/schema).
...
<Callout type="error">
    The `defineTypes()` method was **removed** in Colyseus 0.18 (schema 5) — this legacy example no longer runs and is kept only to help you recognize old code. Migrate to [`schema()` with `t.*` builders](/state/schema).
</Callout>

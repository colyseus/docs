...
class Player extends Schema {
    // tick patches ride the unreliable channel
...
The semantics, use cases and cautions are documented in the [main reference → Delivery modifiers](/state/schema#delivery-modifiers).

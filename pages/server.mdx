...
<Callout type="warning">
    Use these events for logging and monitoring purposes only. It is not encouraged to manipulate a room's state through these events. Use the [Room's Lifecycle Events](/room/lifecycle) in your room class instead.
</Callout>
...
Revert a room definition — makes a `roomName` unavailable for matchmaking. This

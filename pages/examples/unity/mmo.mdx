...
![Screenshot](/examples/unity/mmo/screenshot.PNG)

## Getting Started

### Launching a local server

You need to install and launch the server from the **provided Server directory** for this demo to function properly. Simply follow the instructions found underneath ["Running the demo server" in the Unity section of these docs](/getting-started/unity#running-the-server-locally).
...
![MapScreenshop](/examples/unity/mmo/map.PNG)
...
### Chat System
![ChatScreenshot](/examples/unity/mmo/chatScreenshot.PNG)
...
![Interactables](/examples/unity/mmo/coinOp.PNG)

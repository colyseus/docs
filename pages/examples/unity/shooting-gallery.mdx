...
![Screenshot](/examples/unity/shooting-gallery/screenshot.png)
...
![numberOfTargetRows](/examples/unity/shooting-gallery/number-of-target-rows.png)
...
![Time between targets](/examples/unity/shooting-gallery/time-between-targets.png)

The TargetBase objects control their own speed here:

![Move speed](/examples/unity/shooting-gallery/move-speed.png)

### Adjusting the guns

The important values for the gun can be changed on the Gun prefab here:

![Guns](/examples/unity/shooting-gallery/guns.png)

...
<Steps>
    ...
    <SDKTabs>
        ...
        # join room
        var room: ColyseusRoom = client.join_or_create("my_room")
    ...
    <SDKTabs>
        ...
        func _on_entity_add(entity: Dictionary, session_id: String):
            print("entity added: ", entity)
        ...
        func _on_entity_remove(entity: Dictionary, session_id: String):
...
<SDKTabs>
    ...
    func _on_player_add(player: Dictionary, session_id: String):
...
<SDKTabs>
    ...
    func _on_player_remove(player: Dictionary, session_id: String):
...
<Callout type="warning">
    **Not required when using [JavaScript SDK](/getting-started/typescript) or [Defold SDK](/getting-started/defold)** - The following section is only required when using statically typed languages in your front-end, such as C#, Haxe, etc.
</Callout>

...
- Your game logic may be handled by specialized structures, such as external functions, the [Command Pattern →](/best-practices/command-pattern), or an [Entity-Component System →](/3rd-party-packages#entity-component-system-ecs).
---
title: "Queue Room"
description: "The built-in QueueRoom is a matchmaking queue that groups players by rank and team over time, then spawns a match room when a group is ready."
---
...
| `maxWaitingCyclesForPriority` | `number` | `10` | Cycles after which a client becomes high-priority and can bypass `compare`. ⚠ In 0.18.1 this one is **not** applied from `defineRoom` options — override the class field in a subclass to change it. |

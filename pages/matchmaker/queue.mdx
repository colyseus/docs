...
| `maxWaitingCyclesForPriority` | `number` | `10` | Cycles after which a client becomes high-priority and can bypass `compare`. ⚠ Not applied from `defineRoom` options in 0.18.1 — subclass to change it. |

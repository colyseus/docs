...
<Callout type="info">
    **Consuming the seat reservation** - You can use [`consumeSeatReservation()` from the frontend](/client/#consumeseatreservation-reservation) to join the room by its reserved seat.
</Callout>

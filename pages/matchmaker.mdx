...
<Callout type="info">
    **Consuming the seat reservation** - You can use [`consumeSeatReservation()` from the frontend](/client/#consume-seat-reservation) to join the room by its reserved seat.
</Callout>

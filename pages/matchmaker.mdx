...
connection. See [Joining Rooms](/sdk#joining-rooms) for the frontend.
...
From your server code, you can create rooms, join players to existing rooms, query available rooms, and reserve seats. You can also monitor statistics across processes — connected users (CCU) and room counts — and call methods on rooms running in a different process. None of it depends on a client request.

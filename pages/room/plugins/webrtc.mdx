---
title: "WebRTCPlugin"
description: "Add WebRTC peer-to-peer signaling (audio/video) to a Colyseus room with a single plugin — handles peer list, SDP offer/answer, ICE candidates, and peer-left events."
---

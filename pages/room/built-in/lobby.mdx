...
Rooms flagged [`private` or `unlisted`](/room/visibility#matchmaking-properties) never appear in the lobby listing. (`locked` rooms remain listed, marked as locked.)

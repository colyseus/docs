...
If you rely on this method, you can easily re-implement it on your backend code, although it's recommended to implement a more secure way to query rooms, such as using the `LobbyRoom`.

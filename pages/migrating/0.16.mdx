...
description: "Migration guide from Colyseus 0.15 to 0.16. Covers breaking changes, new features, and updated APIs."
---
...
The callback methods have been extracted out of the `Schema` instances. To attach callbacks, you now have to get a proxied version of your instances via `$(yourInstance)`.
...
If you rely on this method, you can easily re-implement it on your backend code. A more secure way to query rooms is recommended, such as using the `LobbyRoom`.

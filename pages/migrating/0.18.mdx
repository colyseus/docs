...
description: "Migration guide from Colyseus 0.17 to 0.18. Covers the AUTH_SALT deprecation, the password-reset requirement for @colyseus/auth users, and the new @colyseus/database / @colyseus/admin packages."
---

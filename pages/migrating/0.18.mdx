...
This is additive — existing two-argument handlers are unaffected. See [Room → Responding to a message](/room#responding-to-a-message-requestresponse) and [SDK → Request/Response](/sdk#requestresponse).

...
```json filename="package.json"
{
    "dependencies": {
        "colyseus": "^0.17.6",
        "@colyseus/core": "^0.17.16",
        "@colyseus/tools": "^0.17.12",
        "@colyseus/ws-transport": "^0.17.6",
        "@colyseus/monitor": "^0.17.6", // (optional)
        "@colyseus/playground": "^0.17.7", // (optional)
        "@colyseus/redis-driver": "^0.17.5", // (optional)
        "@colyseus/redis-presence": "^0.17.5", // (optional)
        "@colyseus/auth": "^0.17.5", // (optional)
        "@colyseus/loadtest": "^0.17.7", // (optional)
        "@colyseus/testing": "^0.17.10", // (optional)
        "@colyseus/uwebsockets-transport": "^0.17.6", // (optional)
    }
}
```

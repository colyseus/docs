...
description: "Migration guide from Colyseus 0.14 to 0.15. Covers breaking changes, renamed packages, and updated APIs."
---
...
Only JavaScript/TypeScript is affected. If you use a frontend SDK other than JavaScript/TypeScript, no change is needed on the frontend for you.
...
To make this intent more explicit, the second argument is now mandatory, either `"manual"` or the number of seconds to wait for reconnection:
...
The loadtest tool has been reworked to allow for more complex scripting, so your loadtest scripts will need to be slightly rewritten. The new format looks like this:
...
```
See https://docs.colyseus.io/sdk/#on-leave-event and https://docs.colyseus.io/room/#leave-room

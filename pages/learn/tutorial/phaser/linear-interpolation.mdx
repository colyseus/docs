...
On [Part 1](basic-player-movement) of this tutorial, we used `callbacks.onChange()` to update the player's visual representation the instant state updates arrive from the server:

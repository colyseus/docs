...
In the overridden `CreateRoom` function in `StarBossLobbyController.cs` on the frontend, you can see where we determine if we're launching a room of type Team Deathmatch or Co-op:
```csharp

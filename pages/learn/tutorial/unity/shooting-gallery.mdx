---
title: Shooting Gallery Demo
description: "Build a turn-based multiplayer shooting gallery with Unity and Colyseus."
---
...
![Screenshot](/tutorial/unity/shooting-gallery/screenshot.png)
...
![numberOfTargetRows](/tutorial/unity/shooting-gallery/number-of-target-rows.png)

This number is sent to the server when a room initializes. The server uses it when randomly selecting a target's row.

The treadmills individually control the frequency with which they'll send out targets:

![Time between targets](/tutorial/unity/shooting-gallery/time-between-targets.png)

The TargetBase objects control their own speed here:

![Move speed](/tutorial/unity/shooting-gallery/move-speed.png)

### Adjusting the guns

The important values for the gun can be changed on the Gun prefab here:

![Guns](/tutorial/unity/shooting-gallery/guns.png)

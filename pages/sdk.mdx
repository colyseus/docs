...
{/*
  Connection lifecycle moved to a child page; keep old deep links working.
  `#connection-lifecycle` is absent on purpose: that heading survives here as
  a pointer, and redirecting it would make this page's own table of contents
  bounce readers away.
*/}
<MovedAnchors map={{

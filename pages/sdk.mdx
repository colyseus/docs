...
<Tabs items={["TypeScript", "JavaScript", "Unity (C#)", "Defold (Lua)", "Haxe", "Godot (GDScript)"]} storageKey='sdk-tab-language'>
...
<Tabs items={["TypeScript", "JavaScript", "Unity (C#)", "Defold (Lua)", "Haxe", "Godot (GDScript)"]} storageKey='sdk-tab-language'>
    ...
    <Tabs.Tab>
    ```gdscript filename="client.gd"
    var room: ColyseusRoom = client.join_or_create("battle")
...
<Tabs items={["TypeScript", "JavaScript", "Unity (C#)", "Defold (Lua)", "Haxe", "Godot (GDScript)"]} storageKey='sdk-tab-language'>
    ...
    ```cs filename="Client.cs"
    try {
      Colyseus.Room<YourStateClass> room = await client.Create<YourStateClass>("battle", /* Dictionary of options */);
      Debug.Log("joined successfully");
    ...
    <Tabs.Tab>
    ```gdscript filename="client.gd"
    var room: ColyseusRoom = client.create("battle")
...
<Tabs items={["TypeScript", "JavaScript", "Unity (C#)", "Defold (Lua)", "Haxe", "Godot (GDScript)"]} storageKey='sdk-tab-language'>
    ...
    ```cs filename="Client.cs"
    try {
      Colyseus.Room<YourStateClass> room = await client.Join<YourStateClass>("battle", /* Dictionary of options */);
      Debug.Log("joined successfully");
    ...
    <Tabs.Tab>
    ```gdscript filename="client.gd"
    var room: ColyseusRoom = client.join("battle")
...
<Tabs items={["TypeScript", "JavaScript", "Unity (C#)", "Defold (Lua)", "Haxe", "Godot (GDScript)"]} storageKey='sdk-tab-language'>
    ...
    ```cs filename="Client.cs"
    try {
      Colyseus.Room<YourStateClass> room = await client.JoinById<YourStateClass>("battle", /* Dictionary of options */);
      Debug.Log("joined successfully");
    ...
    <Tabs.Tab>
    ```gdscript filename="client.gd"
    var room: ColyseusRoom = client.join_by_id("KRYAKzRo2")
...
<Tabs items={["TypeScript", "JavaScript", "Unity (C#)", "Defold (Lua)", "Haxe", "Godot (GDScript)"]} storageKey='sdk-tab-language'>
    ...
    ```cs filename="Client.cs"
    try {
      Colyseus.Room<YourStateClass> room = await client.ConsumeSeatReservation<YourStateClass>(reservation);
      Debug.Log("joined successfully");
    ...
    <Tabs.Tab>
    ```gdscript filename="client.gd"
    var room: ColyseusRoom = client.consume_seat_reservation(reservation)
...
<Tabs items={["TypeScript", "JavaScript", "Unity (C#)", "Defold (Lua)", "Haxe", "Godot (GDScript)"]} storageKey='sdk-tab-language'>
    ...
    func _on_state_changed():
        ...
        print("the room state has been updated: ", state)
    ```
    </Tabs.Tab>
</Tabs>
...
<SDKTabs>
    ...
    ```gdscript filename="client.gd"
    # get state callbacks handler
    var callbacks: ColyseusCallbacks = Colyseus.callbacks(room)
    ```
    </Tabs.Tab>
</SDKTabs>
...
<Tabs items={["TypeScript", "JavaScript", "Unity (C#)", "Defold (Lua)", "Haxe", "Godot (GDScript)"]} storageKey='sdk-tab-language'>
    ...
    <Tabs.Tab>
    ```gdscript filename="client.gd"
    var room: ColyseusRoom = client.reconnect(cached_reconnection_token)
...
<Tabs items={["TypeScript", "JavaScript", "Unity (C#)", "Defold (Lua)", "Haxe", "Godot (GDScript)"]} storageKey='sdk-tab-language'>
    ...
    client.set_endpoint(endpoints[0])  # Set your preferred endpoint
    ```
    </Tabs.Tab>
</Tabs>

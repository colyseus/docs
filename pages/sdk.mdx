...
| `consumeSeatReservation` | `client.consumeSeatReservation(reservation)` | Joins using a pre-reserved seat from the server. See [Match-maker → Reserve Seat For](/matchmaker#reserve-a-seat-for). |

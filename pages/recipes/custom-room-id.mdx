...
description: "How to set a custom room ID in Colyseus instead of using the default auto-generated ID."
---
...
Step 2 here will most likely take only a single iteration, even with millions of rooms, with a 4 letter room ID. Using the Presence API this way also moves you closer to running your server on multiple machines: just switch to the [RedisPresence](/server/presence#redis-presence).

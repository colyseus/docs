...
Not yet—client-prediction is planned for a future release (see [Roadmap](/roadmap)). For now, see our [Phaser tutorial](/tutorial/phaser/client-predicted-input) for a reference implementation.

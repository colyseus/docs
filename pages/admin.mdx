...
| `minPasswordLength` | `number` | `8` | Minimum password length accepted by bootstrap and reset endpoints. Plain length check applied by the bootstrap and reset endpoints. |

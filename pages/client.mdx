...
Unique identifier for the current connected client. This property matches the [`client.sessionId`](/server/room#client/#sessionid-string) from the server-side.

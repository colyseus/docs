...
TODO:
- [ ] Connection state recovery after a disconnect (1001, 1005, 1006)
- [ ] Move frontend schema callbacks to this page

# Frontend SDK

<Cards>
    <Cards.Card icon={<ZapIcon/>} title="Getting Started" href="/getting-started" />
    <Cards.Card icon={<SyncIcon />} title="Frontend Callbacks" href="/state/callbacks" />
</Cards>
...
For fine-grained control over state updates, see [State Synchronization → Frontend Callbacks](/state/callbacks).
...
<Callout type="info">
    Check out the [State Synchronization » Frontend Callbacks](/state/callbacks) section for more details.
</Callout>

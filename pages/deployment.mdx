---
title: "Deployment"
description: "Deploy your Colyseus server to production. Guides for Colyseus Cloud, Vultr, Docker, and custom environments."
---
...
Deploying Colyseus is no different than deploying a regular Node.js application - [see a good article here](https://www.digitalocean.com/community/tutorials/how-to-set-up-a-node-js-application-for-production-on-ubuntu-20-04). However, scaling Colyseus to use multiple processes requires extra steps - see [Scalability](/scalability).
...
Heroku has no built-in support for scaling to multiple processes or nodes, so we don't recommend it for production.

...
- 下載 [colyseus-cocos2d-x](https://github.com/colyseus/colyseus-cocos2d-x/archive/master.zip) 並將 `Source/` 文件復製到你的專案中.
- 添加 `Source/` 目錄至你專案的 `Header Search Paths`.
...
下方你可以看到如何使用 `Client`, 匹配進入 `Room`, 以及從已連線的房間發送並接收消息.
